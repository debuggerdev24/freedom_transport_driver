...
class _DropLocationState extends State<DropLocation>
  ...
  void initState() {
    ...
    initializeData();
    getuser();
    filterlist = List.from(getuserlist);
  ...
  void filterSuggestions() {
    String query = username.text.toLowerCase();
    setState(() {
      filterlist = getuserlist
          .where((user) =>
              user['name']?.toLowerCase().contains(query) == true ||
              user['surname']?.toLowerCase().contains(query) == true)
          .toList();
    });

    log("Filtered List========>${filterlist}");
  }
  ...
  Future<void> initializeData() async {
    ...
    if (addressList.isNotEmpty) {
      ...
      log("dropaddressconfirmation========>${dropAddressConfirmation}");
    }
  }
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    (etaDetails['total'] ?? 0.0)
                                                        .toStringAsFixed(
                                                            2), // Default to 0.0 if null
                                                    style: GoogleFonts.notoSans(
                                                      color: textColor,
                                                    ),
                                                  )
                                                      ...
                                                      return ListTile(
                                                        ...
                                                        onTap: () {
                                                          if (filterlist
                                                            ...
                                                            if (selectedUserId ==
                                                              ...
                                                              selectedUserId =
                                                                  int.parse(user[
                                                                          'id']
                                                                      .toString());
                                                              log("Selected User ID on first tap: $selectedUserId");
                                                            }
                                                            ...
                                                            log("The filterlist is empty or index is out of range");
                                                          }
                                                        },
                                                      );
                                                    },
                                                            ...
                                                            if (dropAddressConfirmation
                                                              ...
                                                              if (username.text
                                                                ...
                                                                if (addressList
                                                                  ...
                                                                  var dropAddress =
                                                                      addressList.firstWhere((element) =>
                                                                          element
                                                                              .type ==
                                                                          'drop');
                                                                  dropAddress
                                                                ...
                                                                if (addressList
                                                                        .length ==
                                                                    2) {
                                                                  log("addressList ======>${addressList.length}");
                                        ...
                                        onTap: () async {
                                          if (dropAddressConfirmation
                                            ...
                                            if (addressList
                                              ...
                                              var dropAddress = addressList
                                                  .firstWhere((element) =>
                                                      element.type == 'drop');
                                              dropAddress.address =
                                                  dropAddressConfirmation;
                                              dropAddress.latlng = LatLng(
                                                  _center.latitude,
                                                  _center.longitude);
                                            }

                                            // Ensure both addresses are set
                                            if (addressList.length == 2) {
                                              ...
                                              if (etaResponse == 'logout') {
                                                navigateLogout();
                                              } else if (etaResponse == false) {
                                                setState(() {
                                                  _errorText =
                                                      languages[choosenLanguage]
                                                          ['text_eta_failed'];
                      ...
                      // (droplocation == false && etaDetails.isNotEmpty)
                      //     ? Positioned(
                      //         bottom:
                      //             0 + MediaQuery.of(context).viewInsets.bottom,
                      //         child: Container(
